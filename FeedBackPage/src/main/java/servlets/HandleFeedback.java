...
public class HandleFeedback extends HttpServlet {
	...
	// As we are not using the get() method we do not need to code it separately
	// But we will still reuse post() method code to avoid errors if get() method is called
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    printWriter.print("Response : " + feedbackParam + "<br>");
